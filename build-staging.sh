...
sentry-cli releases -o the-social-edge -p contempo-staging new $GIT_COMMIT
sentry-cli releases -o the-social-edge -p contempo-staging files $GIT_COMMIT upload-sourcemaps build/assets/
