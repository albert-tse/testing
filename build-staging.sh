...
sentry-cli releases -o the-social-edge -p contempo-staging new $APP_VERSION --ref $GIT_COMMIT
sentry-cli releases -o the-social-edge -p contempo-staging files $APP_VERSION --ref $GIT_COMMIT upload-sourcemaps build/assets/
