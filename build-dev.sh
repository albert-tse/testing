...
sentry-cli releases -o the-social-edge -p contempo-dev new $GIT_COMMIT
sentry-cli releases -o the-social-edge -p contempo-dev files $GIT_COMMIT upload-sourcemaps build/assets/
