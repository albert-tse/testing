...
export default class Cards extends Component {
    ...
    render() {
        ...
        let displayWidgets = [
            ...
            <Widget key='2' label="Total Posts" value={totalPosts && numeral(totalPosts).format('0.00a')} />,
        ...
        const internalWidgets = [
            ...
            <Widget key='9' label="Posts Per Day" value={postsPerDay && numeral(postsPerDay).format('0.00a')} />,
